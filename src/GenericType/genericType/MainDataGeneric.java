...
//        data4.setData(new Product("Baju",25000.00));
        ...
        DataGeneric<Animal> data9 = new DataGeneric<>(new Animal("Kucing",4,"Darat",true));
        System.out.println("data 9 value : "+data9.getData());

        DataGeneric<String> data10 = new DataGeneric<>("Data 5");
        System.out.println("Data10 Value : "+ data10.getData());
